...
<a href="{{ route('invitations.accept', $invitation->token) }}" style="background-color: #15803d; color: white; padding: 10px 15px; text-decoration: none; border-radius: 5px;">Accept Invitation</a>
